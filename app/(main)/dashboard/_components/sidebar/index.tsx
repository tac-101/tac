...
export function DashboardSidebar({
	...
	return (
		<Sidebar
			...
			variant="inset"
			className={cn(
				"bg-sidebar/40 backdrop-blur-xl border-none",
				className,
			)}
			collapsible="icon"
		>
			<SidebarHeader className="flex gap-3 flex-row items-center border-b border-white/5 pb-4">
				<SidebarLogo />
			...
			<SidebarFooter className="p-0 border-t border-white/5">
				<SidebarMenu>
					<SidebarMenuItem>
						<DropdownMenu>

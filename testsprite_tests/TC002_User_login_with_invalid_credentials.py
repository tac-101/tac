...
async def run_test():
    ...
    try:
        ...
        # Click on 'Portal' button to go to the login page
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login attempt with invalid username or password did not fail as expected, or the appropriate error message was not displayed.')

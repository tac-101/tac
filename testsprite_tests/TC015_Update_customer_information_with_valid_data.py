...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Portal' button to access login or user portal for authorized user login.
        ...
        # -> Input authorized user email and password, then click 'Sign In' button.
        frame = context.pages[-1]
        ...
        # -> Click 'Sign In' button to log in as authorized user.
        frame = context.pages[-1]
        # Click 'Sign In' button to log in as authorized user
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Customer Update Successful').first).to_be_visible(timeout=30000)
        except AssertionError:
            raise AssertionError("Test case failed: The test plan execution has failed because the customer details update did not complete successfully. Expected confirmation message 'Customer Update Successful' was not found on the page.")
